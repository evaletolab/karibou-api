...
exports.Orders=[
    ...
    {
        _id: ObjectId("53f12f09a328f285313bda01"),
        oid: 2000016,
        /* customer */
        customer: u.Users[1],
        ...
        shipping: { 
        	...
        	note: "123456", streetAdress: "route de chêne 34", floor: "2", 
        	postalCode: "1208", region: "Genève", 
        	when: sellerDay, geo: { lat: 46.1997473, lng: 6.1692497}},

        /* vendors */
        vendors: [
            {
                ref: ObjectId('515ec12e56a8d5961e000004'),
                slug: "un-autre-shop-2",
                name: "Un autre shop",
                address: "TODO",
            },
            {
